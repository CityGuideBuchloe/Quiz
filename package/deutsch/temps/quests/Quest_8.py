...
class Quest_8(QDialog): 
    def __init__(self, score, parent=None): 
        ...
        self.quest.setText("Was ist der Slogan der Stadt??")

        self.answer1 = QCheckBox(self)
        self.answer1.setText("Buchloe hat keinen Slogan.")

        self.answer2 = QCheckBox(self)
        self.answer2.setText("Tor zum Süden")

        self.answer3 = QCheckBox(self)
        self.answer3.setText("Tor zum Ostallgäu")
    ...
    def NextFunc(self): 
        if self.answer1.isChecked() == False and self.answer2.isChecked() == False and self.answer3.isChecked(): 
            ...
            dial = False_Window("Das ist nicht richtig, die richtige Anwtort wäre 'Tor zum Ostallgäu'")
            self.close() 
