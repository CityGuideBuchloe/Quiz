...
class Quest_1(QDialog): 
    def __init__(self, score, parent=None): 
        ...
        self.quest.setText("Welche Flüsse fließen durch Buchloe??")

        self.answer1 = QCheckBox(self)
        self.answer1.setText("Die Gennach und die Salach")

        self.answer2 = QCheckBox(self)
        self.answer2.setText("Der Rhein und die Donau")

        self.answer3 = QCheckBox(self)
        self.answer3.setText("Die Elbe und die Wertach")
    ...
    def NextFunc(self): 
        if self.answer1.isChecked() and self.answer2.isChecked() == False and self.answer3.isChecked() == False: 
            ...
            dial = False_Window("Das ist nicht richtig, die richtige Anwtort wäre die Gennach und die Salach.")
            self.score+=0
            self.close() 
